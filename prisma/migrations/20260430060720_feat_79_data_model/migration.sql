/*
  ...
  - Added the required column `role` to the `admin_users` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "email" TEXT NOT NULL DEFAULT 'admin@centient.work',
