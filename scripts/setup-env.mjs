...
// Minimum withdrawal balance in stroops — getMinWithdrawalStroops() throws if
// unset/invalid, so scaffold a usable default (1 XLM = 10000000 stroops).
ensure("MIN_WITHDRAWAL_STROOPS", "10000000", (v) => isMissing(v) || !/^\d+$/.test(v));
